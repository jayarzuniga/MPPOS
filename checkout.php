...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $_SESSION['receiptData'] = $cartItems;
     ...
     // Store the payment data in a session variable
     $paymentData = $requestData['data'];
    ...
    $stmt = $conn->prepare("INSERT INTO purchases (seller,currentDate, product_name, price) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("sssd",$_SESSION['name'], $currentDate, $productName, $price);
